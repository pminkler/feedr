...
<template>
  <div class="max-w-3xl mx-auto p-6">
    ...
    <p
      class="mb-4"
      v-html="t('termsOfService.intro', { appName: 'Feedr' })"
    ></p>
    ...
    <p
      class="mb-4"
      v-html="t('termsOfService.section1.paragraph', { appName: 'Feedr' })"
    ></p>
    ...
    <p
      class="mb-4"
      v-html="t('termsOfService.section2.paragraph', { appName: 'Feedr' })"
    ></p>
    ...
    <p
      class="mb-4"
      v-html="t('termsOfService.section6.paragraph', { appName: 'Feedr' })"
    ></p>
    <ul class="list-disc list-inside mb-4">
    ...
    <p
      class="mb-4"
      v-html="t('termsOfService.section7.paragraph', { appName: 'Feedr' })"
    ></p>
    <ul class="list-disc list-inside mb-4">
    ...
    <p
      class="mb-4"
      v-html="t('termsOfService.section8.paragraph', { appName: 'Feedr' })"
    ></p>
    ...
    <p
      class="mb-4"
      v-html="t('termsOfService.section9.paragraph', { appName: 'Feedr' })"
    ></p>
