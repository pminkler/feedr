  ...
  messages: {
      ...
      recipe: {
        ...
        instacart: {
          ...
          affiliate: {
            ...
            tooltip:
              'Click to add ingredients to Instacart and get delivery in as fast as one hour!',
          },
        },
        share: {
    ...
    fr: {
      ...
      recipe: {
        ...
        error: {
          title: 'Erreur',
          description: 'Une erreur est survenue lors de la récupération de la recette.',
          action: 'Réessayer',
          failedTitle: 'Erreur !',
          failedDescription:
      ...
      recipe: {
        ...
        instacart: {
          ...
          affiliate: {
            ...
            tooltip:
              '¡Haz clic para agregar ingredientes a Instacart y recibir la entrega en tan solo una hora!',
          },
        },
        share: {
